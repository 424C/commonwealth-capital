...
export default function Home() {
  ...
  const [MAX_NFT_SUPPLY, setMAX_NFT_SUPPLY] = useState("103");
  ...
  return (
    <div>
      <Head>
        <title>BeanieDAO</title>
        <meta name="description" content="Whitelist-Dapp" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>BeanieDAO</h1>
          <div className={styles.description}>
            Decentralized Autonomous Organization governed by BB NFT holders.
          </div>
          <div className={styles.description}>
        ...
        <div>
          <img className={styles.image} src="./beanieNFT/61.jpeg" />
        </div>
      </div>

      <footer className={styles.footer}>
        Disclaimer: This is a fan made project and not affiliated with TY in any
        way.
      </footer>
    </div>
  );
